        ...
        <header className='main-header' id='header'>
            <div className='main-header__titles'>
                ...
                <div className='main-header__navigation'>
                    <ContactLink href='https://www.linkedin.com/in/facundo-c%C3%A1ceres/' src='https://icongr.am/devicon/linkedin-original.svg?size=83&color=000000' alt='linkedin logo' title='linkedin' />
