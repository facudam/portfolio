    ...
    return(
        <section id='skills' className='skills-section'>
            ...
            <div className='skills-section__technologies'>
                ...
                <figure title='CSS'>
                    <img src='https://icongr.am/devicon/css3-original-wordmark.svg?size=75&color=currentColor' alt='CSS logo' />  
                </figure>
                <figure title='JAVASCRIPT'>
                    <img src='https://icongr.am/devicon/javascript-original.svg?size=75&color=currentColor' alt='javascript logo'  /> 
                </figure>
                <figure title='REACT JS'>
                    <img src='https://icongr.am/devicon/react-original.svg?size=75&color=currentColor' alt='REACT logo' /> 
                </figure>
                <figure title='GIT'>
                    <img src='https://icongr.am/devicon/git-plain.svg?size=75&color=currentColor' alt='git logo' /> 
                </figure>
                <figure title='GITHUB'>
                    <img src='https://icongr.am/devicon/github-original.svg?size=75&color=currentColor' alt='github logo' />
                </figure>
                <figure title='TAILWIND'>
